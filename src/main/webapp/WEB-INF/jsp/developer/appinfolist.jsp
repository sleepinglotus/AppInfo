				...
				<div class="row">
					...
					<a href="${pageContext.request.contextPath}/dev/flatform/app/appinfoadd" class="btn btn-success btn-sm">新增APP基础信息</a>
						<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed"
							...
							<tbody>
								<c:forEach var="appInfo" items="${pageBean.pageList }" varStatus="status">
				...
				<div class="row">
					<div class="col-sm-5">
						<div class="dataTables_info" id="datatable-responsive_info"
							...
							${pageBean.pageNo }/${pageBean.totalPages }页</div>
					</div>
					<div class="col-sm-7">
							...
							<ul class="pagination">
								<c:if test="${pageBean.pageNo > 1}">
									...
									<li class="paginate_button "><a
										href="javascript:page_nav(document.forms[0],${pageBean.pageNo-1});"
								...
								<c:if test="${pageBean.pageNo < pageBean.totalPages }">
									...
									<li class="paginate_button next"><a
										href="javascript:page_nav(document.forms[0],${pageBean.totalPages});"
